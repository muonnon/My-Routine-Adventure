...
public class Routine {
	...
	// ⭐ 마지막 완료 날짜 기록 필드 추가 - map으로 변경 251119
	...
	// ⭐ 로컬데이트에 관한 Getter 및 Setter 추가 수정 251119
	public Map<String, LocalDate> getLastCompletedDate() { // --251112
		return lastCompletedDate;
	}

	public void setLastCompletedDate(Map<String, LocalDate> lastCompletedDate) { // --251112
	...
	public void setRepeatDays(List<String> repeatDays) {
		this.repeatDays = new ArrayList<>(repeatDays);
	} // ⭐ 리스트 교체
